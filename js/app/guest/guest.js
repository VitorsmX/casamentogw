...
export const guest = (() => {
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = {
            action: 'TEMPLATE',
            text: 'O Casamento de Gabriela e Wanderson',
            dates: `${formatDate('2025-06-22 07:30')}/${formatDate('2025-06-22 12:00')}`,
            details: 'O casamento ocorrerá na Reserva Apuí (Reserva e Restaurante), em Peixe-Boi. Após a cerimônia religiosa ocorrerá um café da manhã em torno das 10:00 no mesmo local',
            location: 'https://maps.app.goo.gl/xFvTm89jcUBxwKiv9',
            ctz: 'America/Belem',
        };
